...
//                println(travelCost)
    ...
    //In side room1
    private fun sr1(data: List<List<String>>, i: Int, j: Int): Boolean {
        return i == 2
    }

    private fun sr2(data: List<List<String>>, i: Int, j: Int): Boolean {
        return i == 3
    }

    private fun hallway(data: List<List<String>>, i: Int, j: Int): Boolean {
        return i == 1
    }
