...
class Day22Solver : DaySolver<List<String>, Long> {
    ...
    private fun case4(x: Long, y: Long, x1: Long, y1: Long): Boolean {
        return x == y1 && x1 < x
    }
    ...
    private fun case10(x: Long, y: Long, x1: Long, y1: Long): Boolean {
        return y == x1 && y < y1
    }

    private fun case11(x: Long, y: Long, x1: Long, y1: Long): Boolean {
        return x == x1 && x1 == y1
    }

    private fun case12(x: Long, y: Long, x1: Long, y1: Long): Boolean {
        return y == x1 && x1 == y1
    }
